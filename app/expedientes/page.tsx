  ...
  return (
    <AppShell>
      ...
      <div className="flex flex-col lg:flex-row gap-4 mb-6">
        ...
        >
          <TabsList className="h-auto flex-nowrap overflow-x-auto justify-start bg-muted/50 p-1 no-scrollbar">
            <TabsTrigger value="todos" className="text-xs shrink-0">
              Todos
            </TabsTrigger>
            <TabsTrigger value="alquiler" className="text-xs shrink-0">
              Alquiler
            </TabsTrigger>
            <TabsTrigger value="venta" className="text-xs shrink-0">
              Venta
            </TabsTrigger>
            <TabsTrigger value="reserva" className="text-xs shrink-0">
              Reserva
            </TabsTrigger>
            <TabsTrigger value="arras" className="text-xs shrink-0">
              Arras
            </TabsTrigger>
            <TabsTrigger value="pendiente_firma" className="text-xs shrink-0">
              Pendiente
            </TabsTrigger>
            <TabsTrigger value="completado" className="text-xs shrink-0">
              Completado
            </TabsTrigger>
          </TabsList>
        </Tabs>
